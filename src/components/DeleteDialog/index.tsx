...
const DeleteConfirmationDialog: React.FC<DeleteConfirmationDialogProps> = ({ tournamentName, tournamentId, onConfirm }) => {
      ...
      <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleConfirmDelete} className='bg-red-600 hover:bg-red-700'>Confirmar</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
